...
#出力ファイル名
filename ='Narou_All_OUTPUT_word.xlsx'
...
#　GETパラメータ　詳しくは「なろうディベロッパー」を参照
genre_set = ['101','102','201','202','301','302','305','307','9999','303','304','306','401','402','403','404','9901','9902','9903','9904','9801']
...
def get_data():
    for gen in genre_set:
        payload = {'out': 'json','gzip':5,'opt':'weekly','lim':500,'genre':gen,'word':word_set,'notword':notword_set,'title':title_set,'ex':ex_set,'keyword':keyword_set,'wname':wname_set}
        res = requests.get('https://api.syosetu.com/novelapi/api/', params=payload).content
        r =  gzip.decompress(res).decode("utf-8")
        dump_to_list(r);                    
        tm.sleep(interval);
